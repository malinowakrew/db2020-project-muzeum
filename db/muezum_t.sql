...
--
-- Host: 127.0.0.1
-- Czas generowania: 03 Cze 2020, 00:08
...
INSERT INTO `eksponat` (`tytul`, `rok_powstania`, `eksponatID`, `wystawaID`, `opis`) VALUES
('Nie ma tytuły - jest biblioteka', '0000-00-00', 1, 7, NULL),
('Żden', '2020-05-07', 2, 6, NULL),
('nazwa', '1999-01-01', 3, NULL, 0x6e6965206d6fc5bc6e6120777972617a69c487207465676f2073c5826f77616d69),
('nazwa', '0001-01-01', 4, NULL, 0x31),
('muzeum', '0001-01-01', 5, NULL, 0x31),
('{nazwa}', '0000-00-00', 6, 6, 0x7b6f7069737d),
('4', '0004-04-04', 7, 6, 0x3434),
('4', '0004-04-04', 8, 6, 0x34),
('4', '0004-04-04', 9, 6, 0x34),
('3', '0003-03-03', 10, 3, 0x33);
