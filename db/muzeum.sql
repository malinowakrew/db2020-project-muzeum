...
CREATE TABLE `eksponat` (
  ...
  KEY `styl` (`stylID`),
  KEY `typ` (`typID`),
  KEY `wlasciciel` (`wlascicielID`),
  KEY `wystawa` (`wystawaID`),
  CONSTRAINT `styl` FOREIGN KEY (`stylID`) REFERENCES `styl` (`stylID`),
  CONSTRAINT `typ` FOREIGN KEY (`typID`) REFERENCES `typ` (`typID`),
  CONSTRAINT `wlasciciel` FOREIGN KEY (`wlascicielID`) REFERENCES `wlasciciel` (`wlascicielID`),
...
INSERT INTO `eksponat` VALUES ('Nie ma tytuły - jest biblioteka','0000-00-00',1,5,NULL,NULL,7,NULL),('Żden','2020-05-07',2,5,NULL,NULL,6,NULL),('nazwa','1999-01-01',3,NULL,NULL,NULL,NULL,'nie można wyrazić tego słowami'),('nazwa','0001-01-01',4,NULL,NULL,NULL,NULL,'1'),('muzeum','0001-01-01',5,NULL,NULL,NULL,NULL,'1'),('{nazwa}','0000-00-00',6,NULL,NULL,NULL,6,'{opis}'),('4','0004-04-04',7,NULL,NULL,NULL,6,'44'),('4','0004-04-04',8,NULL,NULL,NULL,6,'4'),('4','0004-04-04',9,NULL,NULL,NULL,6,'4'),('3','0003-03-03',10,NULL,NULL,NULL,3,'3');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `styl` (
  `stylID` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `styl` VALUES (4,'nic','nic'),(5,'nic','nic'),(6,'nic','nic'),(7,'nic','nic'),(8,'nic','nic');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `typ` (
  `typID` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wlasciciel` (
  `wlascicielID` int(6) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `wlasciciel` WRITE;
/*!40000 ALTER TABLE `wlasciciel` DISABLE KEYS */;
/*!40000 ALTER TABLE `wlasciciel` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-02 17:55:50
